...
tab_path = '/home/pi/Documents/RobotizeGuitar/Tabs/'  
#--------------------------------------------------------------------------------------------------------
menu = mh.MenuHandler()
# ---------------------------------------------------------------------------------------------------------
...
# GPIO CALLBACK ----------------------------------------------------------------------------------------------------
GPIO.add_event_detect(menu_btn_next, GPIO.FALLING, callback=lambda x:menu_btn_callback(menu_btn_next), bouncetime=300) #SEEMS TO DETECT RISING EDGE ALSO !
GPIO.add_event_detect(menu_btn_previous, GPIO.FALLING, callback=lambda x:menu_btn_callback(menu_btn_previous), bouncetime=300) #SEEMS TO DETECT RISING EDGE ALSO !
GPIO.add_event_detect(menu_btn_validate, GPIO.FALLING , callback=lambda x:menu_btn_callback(menu_btn_validate), bouncetime=300)
GPIO.add_event_detect(menu_btn_return, GPIO.FALLING , callback=lambda x:menu_btn_callback(menu_btn_return), bouncetime=500)
